...
class RequestFailure with _$RequestFailure {
  ...
  const factory RequestFailure.conflict(
    int? errorCode,
    String? errorMessage,
  ) = _Conflict;

  const factory RequestFailure.locked(
    int? errorCode,
    String? errorMessage,
  ) = _Locked;

  const factory RequestFailure.upgradeRequired(
    int? errorCode,
    String? errorMessage,
  ) = _UpgradeRequired;
  ...
  const factory RequestFailure.parsingError(
    int? errorCode,
    String? errorMessage,
  ) = _ParsingError;
}
