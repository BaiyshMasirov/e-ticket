...
import 'package:eticket/presentation/screens/main/models/main_screen_tab.dart'
    as _i16;
import 'package:eticket/presentation/screens/main/screens/booking_ticket/booking_ticket_screen.dart'
    as _i1;
...
abstract class $AppRouter extends _i12.RootStackRouter {
  ...
  final Map<String, _i12.PageFactory> pagesMap = {
    BookingTicketRoute.name: (routeData) {
      final args = routeData.argsAs<BookingTicketRouteArgs>();
      return _i12.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i1.BookingTicketScreen(
...
/// generated route for
/// [_i1.BookingTicketScreen]
class BookingTicketRoute extends _i12.PageRouteInfo<BookingTicketRouteArgs> {
  BookingTicketRoute({
    ...
    List<_i12.PageRouteInfo>? children,
          ...
          BookingTicketRoute.name,
          args: BookingTicketRouteArgs(
            dateTime: dateTime,
            eventId: eventId,
            key: key,
          ),
  ...
  static const String name = 'BookingTicketRoute';

  static const _i12.PageInfo<BookingTicketRouteArgs> page =
      _i12.PageInfo<BookingTicketRouteArgs>(name);
}

class BookingTicketRouteArgs {
  const BookingTicketRouteArgs({
  ...
  @override
  String toString() {
    return 'BookingTicketRouteArgs{dateTime: $dateTime, eventId: $eventId, key: $key}';
  }
}
...
class EventsByTypeRoute extends _i12.PageRouteInfo<EventsByTypeRouteArgs> {
  EventsByTypeRoute({
  ...
  static const _i12.PageInfo<EventsByTypeRouteArgs> page =
      _i12.PageInfo<EventsByTypeRouteArgs>(name);
}
...
class MainRoute extends _i12.PageRouteInfo<MainRouteArgs> {
  MainRoute({
    _i16.MAIN_SCREEN_TAB initialTab = _i16.MAIN_SCREEN_TAB.HOME,
    _i13.Key? key,
    List<_i12.PageRouteInfo>? children,
  }) : super(
          MainRoute.name,
...
class MainRouteArgs {
  const MainRouteArgs({
    this.initialTab = _i16.MAIN_SCREEN_TAB.HOME,
    this.key,
  });

  final _i16.MAIN_SCREEN_TAB initialTab;
