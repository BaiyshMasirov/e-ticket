...
class BalletTheaterRoute extends _i16.PageRouteInfo<void> {
  const BalletTheaterRoute({List<_i16.PageRouteInfo>? children})
      : super(
...
class BishkekArenaPlacesRoute
    extends _i16.PageRouteInfo<BishkekArenaPlacesRouteArgs> {
  BishkekArenaPlacesRoute({
    required _i17.BishkekArenaBlockType blockType,
    _i18.Key? key,
  ...
  static const _i16.PageInfo<BishkekArenaPlacesRouteArgs> page =
      _i16.PageInfo<BishkekArenaPlacesRouteArgs>(name);
}
...
class BishkekArenaPlacesRouteArgs {
  ...
  final _i17.BishkekArenaBlockType blockType;
...
class FilarmoniaSeatPlacesRoute
    extends _i16.PageRouteInfo<FilarmoniaSeatPlacesRouteArgs> {
  ...
  static const _i16.PageInfo<FilarmoniaSeatPlacesRouteArgs> page =
      _i16.PageInfo<FilarmoniaSeatPlacesRouteArgs>(name);
}
