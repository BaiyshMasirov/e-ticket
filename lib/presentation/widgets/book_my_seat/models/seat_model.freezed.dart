...
mixin _$SeatModel {
  ...
  int get rowI => throw _privateConstructorUsedError;
  int get colI => throw _privateConstructorUsedError;
  ...
  int get seatSvgSize => throw _privateConstructorUsedError;
...
class _$SeatModelCopyWithImpl<$Res, $Val extends SeatModel>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      rowI: null == rowI
          ? _value.rowI
          : rowI // ignore: cast_nullable_to_non_nullable
              as int,
      colI: null == colI
          ? _value.colI
          : colI // ignore: cast_nullable_to_non_nullable
              as int,
      pathSelectedSeat: null == pathSelectedSeat
          ? _value.pathSelectedSeat
          : pathSelectedSeat // ignore: cast_nullable_to_non_nullable
              as String,
      pathUnSelectedSeat: null == pathUnSelectedSeat
          ? _value.pathUnSelectedSeat
          : pathUnSelectedSeat // ignore: cast_nullable_to_non_nullable
              as String,
      pathSoldSeat: null == pathSoldSeat
          ? _value.pathSoldSeat
          : pathSoldSeat // ignore: cast_nullable_to_non_nullable
              as String,
      pathDisabledSeat: null == pathDisabledSeat
...
class _$SeatModelImpl extends _SeatModel {
  ...
  @override
  String toString() {
    return 'SeatModel(seatState: $seatState, rowI: $rowI, colI: $colI, pathSelectedSeat: $pathSelectedSeat, pathUnSelectedSeat: $pathUnSelectedSeat, pathSoldSeat: $pathSoldSeat, pathDisabledSeat: $pathDisabledSeat, seatSvgSize: $seatSvgSize)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.rowI, rowI) || other.rowI == rowI) &&
            (identical(other.colI, colI) || other.colI == colI) &&
            ...
            (identical(other.pathUnSelectedSeat, pathUnSelectedSeat) ||
                other.pathUnSelectedSeat == pathUnSelectedSeat) &&
            (identical(other.pathSoldSeat, pathSoldSeat) ||
...
abstract class _SeatModel extends SeatModel {
  const factory _SeatModel(
      ...
      required final int rowI,
      required final int colI,
      ...
      final int seatSvgSize}) = _$SeatModelImpl;
  ...
  @override
  String get pathUnSelectedSeat;
  @override
  String get pathSoldSeat;
  @override
